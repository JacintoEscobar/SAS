...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 24-09-2022 a las 00:59:01
...
(4, 'Arreglos de tipos primitivos', 'Arreglos de tipos de datos primitivos.', 3),
(5, 'Arreglos de objetos', 'Arreglos de objetos. ArrayList.', 3),
(6, 'Parametros por valor', 'Paso de variables por valor.', 7),
(7, 'switch', 'Se ve a profundidad el funcionamiento y uso del switch.', 2),
(8, 'Parametros por referencia', 'Paso de variables por referencia.', 7);
...
(3, 'Arreglos', 'Arreglos en Java.', 5),
(4, 'Clases y objetos', 'Principios de clases y objetos en Java.', 5),
(5, 'Herencia', 'Herencia en Java.', 5),
(6, 'Polimorfismo', 'Polimorfismo en Java.', 5),
(7, 'Funciones', 'Funciones en Java.', 6);
...
--
ALTER TABLE `topico`
  MODIFY `idTopico` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT de la tabla `unidadaprendizaje`
--
ALTER TABLE `unidadaprendizaje`
  MODIFY `idUnidadAprendizaje` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
