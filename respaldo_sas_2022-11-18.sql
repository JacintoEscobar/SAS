...
INSERT INTO `asignacion` VALUES (3,'2022-10-28','2022-11-27',1,1),(4,'2022-11-05','2022-11-18',2,1),(5,'2022-11-11','2022-11-11',3,1),(6,'2022-11-16','2022-11-16',4,1),(7,'2022-11-18','2022-11-22',5,2);
...
INSERT INTO `cuestionario` VALUES (1,'Cuestionario1','Cuestionario 1 de Laura.','cerradas',2),(2,'Cuestionario 2','Cuestionario 2 de Laura.','abiertas',2),(3,'Cuestionario 3','Responde las siguientes preguntas','abiertas',2),(4,'Cuestionario 4','Cuestionario 4','abiertas',2),(5,'Cuestionario 5','Cuestionario 5','cerradas',2);
...
INSERT INTO `cuestionarioresuelto` VALUES (9,1,3),(12,1,4),(8,1,5),(15,1,20),(10,2,3),(11,2,4),(13,3,3),(14,4,3);
...
INSERT INTO `evaluacion` VALUES (1,2,2,3,1001),(2,2,1,3,1003),(3,2,1,5,1001),(4,2,1,4,1000),(5,4,3,3,1003),(6,0,4,3,1002),(7,1,2,4,1006),(8,2,1,20,1003);
...
INSERT INTO `inscripcion` VALUES (1,'activo',1,3),(2,'activo',2,3),(3,'pendiente',3,3),(4,'activo',1,5),(5,'activo',1,4),(6,'activo',2,4),(7,'activo',1,20);
/*!40000 ALTER TABLE `inscripcion` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `material_alumno`
--
...
CREATE TABLE `material_alumno` (
  `idMA` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Llave primaria para identificar la asignacion de un ma a un alumno.',
  `idMaterialEducativo` int(11) NOT NULL COMMENT 'Llave foránea para identificar al material educativo asignado.',
  `idUsuario` int(11) NOT NULL COMMENT 'Llave foránea para identificar al alumno al que se le asignó el material educativo.',
  PRIMARY KEY (`idMA`),
  KEY `idMaterialEducativo` (`idMaterialEducativo`,`idUsuario`),
  KEY `idUsuario` (`idUsuario`),
...
--
-- Dumping data for table `material_alumno`
--

LOCK TABLES `material_alumno` WRITE;
/*!40000 ALTER TABLE `material_alumno` DISABLE KEYS */;
INSERT INTO `material_alumno` VALUES (1,1,3),(2,2,4),(3,2,5),(4,3,3),(5,4,3),(6,4,3);
...
INSERT INTO `materialeducativo` VALUES (1,'Archivo1.docx','../material-educativo/Arcvhio1.docx',1,1000,'archivo'),(2,'Enlace 1','Enlace de material educativo 1.',1,1001,'enlace'),(3,'Enlace 2','https://www.youtube.com/watch?v=kIEWJ1ljEro',1,1000,'enlace'),(4,'Capítulo1 - LauraMartínez.docx','../material-educativo/Capítulo1 - LauraMartínez.docx',7,1003,'archivo'),(5,'Capítulo1 - LauraMartínez.docx','../material-educativo/Capítulo1 - LauraMartínez.docx',7,1003,'archivo');
...
INSERT INTO `notificacion` VALUES (5,'Tienes un nuevo cuestionario. Response Cuestionario1 cuanto antes.',3,3),(6,'Tienes un nuevo cuestionario. Response Cuestionario1 cuanto antes.',3,5),(7,'Tienes un nuevo cuestionario. Response Cuestionario1 cuanto antes.',3,4),(8,'Tienes un nuevo cuestionario. Response Cuestionario 2 cuanto antes.',4,3),(9,'Tienes un nuevo cuestionario. Response Cuestionario 2 cuanto antes.',4,5),(10,'Tienes un nuevo cuestionario. Response Cuestionario 2 cuanto antes.',4,4),(11,'Tienes un nuevo cuestionario. Response Cuestionario 3 cuanto antes.',5,3),(12,'Tienes un nuevo cuestionario. Response Cuestionario 3 cuanto antes.',5,5),(13,'Tienes un nuevo cuestionario. Response Cuestionario 3 cuanto antes.',5,4),(14,'Tienes un nuevo cuestionario. Response Cuestionario 4 cuanto antes.',6,3),(15,'Tienes un nuevo cuestionario. Response Cuestionario 4 cuanto antes.',6,5),(16,'Tienes un nuevo cuestionario. Response Cuestionario 4 cuanto antes.',6,4),(17,'Tienes un nuevo cuestionario. Response Cuestionario 5 cuanto antes.',7,3),(18,'Tienes un nuevo cuestionario. Response Cuestionario 5 cuanto antes.',7,4);
...
INSERT INTO `pregunta` VALUES (1,'Pregunta1Cuestionario1',1),(2,'Pregunta2Cuestionario1',1),(3,'Pregunta3Cuestionario1',1),(4,'Pregunta4Cuestionario1',1),(5,'PreguntaAbierta1',2),(6,'PreguntaAbierta2',2),(7,'PreguntaAbierta3',2),(8,'Pregunta número 1',3),(9,'Pregunta número 2',3),(10,'Pregunta 1',4),(11,'Pregunta 1',5),(12,'Pregunta 2',5);
...
INSERT INTO `registroetiqueta` VALUES (1,1002,5),(2,1002,3),(3,1000,3),(4,1001,5),(5,1001,4),(7,1003,3),(8,1002,3),(9,1006,4),(10,1003,20),(11,1003,20);
...
INSERT INTO `respuestaalumno` VALUES (29,'Respuesta1Pregunta1Cuest1',1,5),(30,'Respuesta1Pregunta2Cuest1',3,5),(31,'Respuesta2Pregunta3Cuest1',6,5),(32,'Respuesta2Pregunta4Cuest1',8,5),(33,'Respuesta1Pregunta1Cuest1',1,3),(34,'Respuesta1Pregunta2Cuest1',3,3),(35,'Respuesta1Pregunta3Cuest1',5,3),(36,'Respuesta1Pregunta4Cuest1',7,3),(46,'respuestaAbierta1',9,3),(47,'respuestaAbierta2',10,3),(48,'Respuesta3',11,3),(49,'respuestaAbierta1',9,4),(50,'Respuesta2',10,4),(51,'Respuesta3',11,4),(52,'Respuesta1Pregunta1Cuest1',1,4),(53,'Respuesta2Pregunta2Cuest1',4,4),(54,'Respuesta1Pregunta3Cuest1',5,4),(55,'Respuesta2Pregunta4Cuest1',8,4),(56,'Respuesta 1',12,3),(57,'Respuesta 2',13,3),(58,'Respuesta 1',14,3),(59,'Respuesta 2',15,3),(60,'Respuesta prueba',16,3),(61,'Respuesta2Pregunta1Cuest1',2,20),(62,'Respuesta1Pregunta2Cuest1',3,20),(63,'Respuesta2Pregunta3Cuest1',6,20),(64,'Respuesta1Pregunta4Cuest1',7,20);
...
INSERT INTO `topico` VALUES (1,'Empty Project','Primer proyecto en Android Studio.',1),(2,'Java o Kotlin','Elección de lenguaje para trabajar en Android Studio.',1),(3,'Tópico 1','Tópico 1 de la unidad de aprendizaje 2.',2),(6,'Topico1','Topico1.',5),(7,'Tópico 1','Tópico 1',6);
...
INSERT INTO `unidadaprendizaje` VALUES (1,'Android Studio','Fundamentos de Android Studio.',1),(2,'Unidad 2','Unidad de aprendizaje 2 de la clase Programación móvil.',1),(5,'Unidad1','Unidad1.',2),(6,'Unidad 3','Unidad 3',1);
...
INSERT INTO `usuario` VALUES (1,'EQJO190657','Jacinto','Escobar','Quezada','eqjo190657@upemor.edu.mx','jacinto','e1efc4c0b611956e6ae5bdb4629eda10','administrador','yoshi.png'),(2,'MCLO190493','Laura Itzel','Martínez','Chávez','mclo190493@upemor.edu.mx','laura','d2f0c294711426f440af6c188232e774','profesor','FB_IMG_1584458786546.jpg'),(3,'DRZO190292','Zuleidi','De la Cruz','Román','drzo190292@upemor.edu.mx','zuleidi','b179a9ec0777eae19382c14319872e1b','alumno','birdo.png'),(4,'EQCO190657','Chinto','Escobar','Quezada','jacesc10@gmail.com','chinto','e1efc4c0b611956e6ae5bdb4629eda10','alumno','perfil.jpg'),(5,'BGB0190657','Benito','Bodoque','Gonzalez','jacesc22@gmail.com','benito','928732a2341b46bcdb770c7c5143dfe1','alumno','cola.jpg'),(15,'OLPO190657','Pedro','Morales','Gutiérrez','olpmo190657@upemor.edu.mx','pedro','5e0c550ebc5db9f1c5ebae8e30ef722e','alumno',NULL),(16,'PPAO190109','Adrian','Perez','Pineda','ppao190109@upemor.edu.mx','adrian','765ba753b609d84b3813991fe23f81b3','profesor',NULL),(17,'MATO190108','Trinidad','Mendez','Aguilar','mato190108@upemor.edu.mx','tomas','9e1873c5561cd8823e70f3283a0d4032','administrador',NULL),(18,'SVEO190396','Eduardo','Solano','Vergara','sveo190396@upemor.edu.mx','eduardo','01f85fd8ff88b23a662ea27f4e14e868','alumno',NULL),(19,'MCLO190493','Laura','Martínez','Chávez','mclo190493@upemor.edu.mx','laura','c427ed4dc3e638ada33850dacc1e6ab6','alumno',NULL),(20,'PPPPPPPP','Patricia','Chapoy','Flores','patychapoyjajaay','paty','6f6a9722fb7144da45a126cb1337647b','alumno',NULL);
...
-- Dump completed on 2022-11-18 14:01:00
