...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 24, 2022 at 04:48 AM
...
CREATE TABLE `cuestionarioresuelto` (
  `idCR` int(11) NOT NULL COMMENT 'Llave primaria para identificar al cuestionario resuelto por un usuario alumno.',
...
INSERT INTO `cuestionarioresuelto` (`idCR`, `idCuestionario`, `idUsuario`) VALUES
(1, 1, 4);
...
(1, 'Tienes un nuevo cuestionario. Responde Cuestionario1 cuanto antes.', 1, 5),
(2, 'Tienes un nuevo cuestionario. Responde Cuestionario1 cuanto antes.', 1, 4),
(3, 'Tienes un nuevo cuestionario. Response Cuestionario 2 cuanto antes.', 2, 3),
(4, 'Tienes un nuevo cuestionario. Response Cuestionario 2 cuanto antes.', 2, 4);
...
CREATE TABLE `respuestaalumno` (
  `idRespuestaAlumno` int(11) NOT NULL COMMENT 'Llave primaria para identificar a la respuesta del alumno.',
...
INSERT INTO `respuestaalumno` (`idRespuestaAlumno`, `contenido`, `idRespuestaMultiple`, `idUsuario`) VALUES
(1, 'Respuesta1Pregunta1Cuest1', 1, 4),
(2, 'Respuesta2Pregunta2Cuest1', 4, 4),
(3, 'Respuesta1Pregunta3Cuest1', 5, 4),
(4, 'Respuesta2Pregunta4Cuest1', 8, 4);
...
--
-- Indexes for table `cuestionarioresuelto`
--
ALTER TABLE `cuestionarioresuelto`
  ADD PRIMARY KEY (`idCR`),
  ADD KEY `idCuestionario` (`idCuestionario`,`idUsuario`),
  ADD KEY `idUsuario` (`idUsuario`);
...
--
-- Indexes for table `respuestaalumno`
--
ALTER TABLE `respuestaalumno`
  ADD PRIMARY KEY (`idRespuestaAlumno`),
  ADD KEY `idUsuario` (`idUsuario`),
  ADD KEY `idRespuestaMultiple` (`idRespuestaMultiple`);
...
--
ALTER TABLE `asignacion`
  MODIFY `idAsignacion` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Llave primaria para identificar a la asignación.', AUTO_INCREMENT=3;
...
--
-- AUTO_INCREMENT for table `cuestionarioresuelto`
--
ALTER TABLE `cuestionarioresuelto`
  MODIFY `idCR` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Llave primaria para identificar al cuestionario resuelto por un usuario alumno.', AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `inscripcion`
--
ALTER TABLE `inscripcion`
  MODIFY `idInscripcion` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Llave primaria para identificar a la inscripción de un alumno a una clase.', AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `notificacion`
--
ALTER TABLE `notificacion`
  MODIFY `idNotificacion` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Llave primaria para identificar a la notificación.', AUTO_INCREMENT=5;
...
--
-- AUTO_INCREMENT for table `respuestaalumno`
--
ALTER TABLE `respuestaalumno`
  MODIFY `idRespuestaAlumno` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Llave primaria para identificar a la respuesta del alumno.', AUTO_INCREMENT=5;
...
--
-- Constraints for table `cuestionarioresuelto`
--
ALTER TABLE `cuestionarioresuelto`
  ADD CONSTRAINT `cuestionarioresuelto_ibfk_1` FOREIGN KEY (`idUsuario`) REFERENCES `usuario` (`idUsuario`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `cuestionarioresuelto_ibfk_2` FOREIGN KEY (`idCuestionario`) REFERENCES `cuestionario` (`idCuestionario`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
-- Constraints for table `respuestaalumno`
--
ALTER TABLE `respuestaalumno`
  ADD CONSTRAINT `respuestaalumno_ibfk_1` FOREIGN KEY (`idUsuario`) REFERENCES `usuario` (`idUsuario`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `respuestaalumno_ibfk_2` FOREIGN KEY (`idRespuestaMultiple`) REFERENCES `respuestamultiple` (`idRespuestaMultiple`) ON DELETE CASCADE ON UPDATE CASCADE;
