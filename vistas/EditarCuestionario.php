...
<head>
    ...
    <title>SAS - Editar cuestionario</title>
...
<body>
    ...
    <main>
        <section>
            <header>
                <h1 id="tituloH1">Llena el formulario para modificar la información del cuestionario</h1>
            </header>
    ...
    <script src="../src/js/editarCuestinario.js"></script>
    <script src="../src/js/setInfoCuestinarioEdit.js"></script>
