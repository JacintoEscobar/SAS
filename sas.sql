...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 12-08-2022 a las 20:51:10
...
INSERT INTO `inscripcion` (`idInscripcion`, `idClase`, `idUsuario`) VALUES
(1, 1, 2),
(2, 2, 2),
(3, 3, 2);
...
(1, 'Jacinto', 'Escobar', 'Quezada', 'jacinto.escobar@gmail.com', 'jasi', 'b0520cf884ac16e8f6e5a21caf0fd453', 'profesor'),
